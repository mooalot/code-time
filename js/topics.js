...
export const COMPANIES = [
  ...
  { id: 'omada',       name: 'Omada Health', blurb: 'Rails pair-programming (debug/extend a small app, TDD) + a dedicated system-design round. Not LeetCode.',
    topics: ['rails', 'sql', 'postgres', 'practical', 'testing', 'system-design', 'web-platform', 'react', 'behavioral'] },
  { id: 'instructure', name: 'Instructure',  blurb: 'Rails + heavy SQL, two-interviewer rounds. Live coding is easy-medium (RPN/stack, sliding window). AI/Claude Code is culture.',
    topics: ['rails', 'sql', 'postgres', 'ai-llm', 'react', 'practical', 'testing', 'system-design', 'web-platform', 'behavioral'] },
  ...
  { id: 'bestow',      name: 'Bestow',       blurb: 'A SQL problem AND an easy-medium LeetCode problem. They want you thinking aloud continuously.',
    topics: ['js-core', 'typescript', 'react', 'frontend-css', 'go-python', 'sql', 'postgres', 'dsa-arrays', 'implement', 'practical', 'testing', 'system-design', 'behavioral'] },
...
export const TOPICS = [
  ...
  {
    id: 'postgres',
    title: 'Postgres & Advanced SQL',
    icon: S('<ellipse cx="17" cy="9" rx="11" ry="4"/><path d="M6 9v12c0 2.2 4.9 4 11 4 1.4 0 2.8-.1 4-.3M6 21v12c0 2.2 4.9 4 11 4 2.4 0 4.6-.3 6.5-.8"/><path d="M33 12l-7 12h5l-2 10 9-14h-5l4-8z"/>'),
    blurb: 'Window functions, CTEs, JSONB, EXPLAIN, index types, MVCC, upserts',
  },
  {
    id: 'rails',
    title: 'Ruby on Rails',
